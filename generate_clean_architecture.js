...
const createStructureWithModules = (modules=[]) =>{
    createFolderArray(
        [
            ...
            'src/app/domain/dto',
            'src/app/use-cases',
            'src/app/infrastructure/global-store/general/actions',
            'src/app/infrastructure/global-store/general/effects',
            'src/app/infrastructure/global-store/general/reducers',
            'src/app/infrastructure/global-store/general/states',
            'src/app/infrastructure/global-store/general/entity',
            'src/app/infrastructure/security',
            'src/app/infrastructure/shared/pages',
            'src/app/infrastructure/shared/components',
            'src/app/infrastructure/services/local',
